...
#pragma omp parallel for
    ...
    inline void hessenbergReductionPartialPiv(double *A, const uint32_t *c, uint32_t *p, uint32_t n, uint32_t cn)
    {
...
// Subtract row a from row b.
        inline void subtract(double *A, const uint32_t a, const uint32_t b, const uint32_t n) {
...
#pragma omp parallel for
        ...
        inline void reduceRow(double *A, const uint32_t a, const uint32_t b, const uint32_t n) {
