...
Related to the Bolsig manual p. 18:
Substitution of \eqref{eq:sst-alpha-solution} in \eqref{eq:ebe-2term-f-u1(u)-spat-v_z}
yields an expression for $\MEAN{v_z}$ in terms of $\mu_e$, $D_e$ and $\MEAN{\nu_{\mbox{eff}}}$,
\begin{equation}
	\MEAN{v_z}
	= \frac{\mu_e E}{2} +\frac{1}{2}\sgn(\mu_eE)\sqrt{(\mu_eE)^2-4D_e\MEAN{\nu_{\mbox{eff}}}}
	= \frac{\mu_e E}{2}\left(1 +\sqrt{1-\frac{4D_e\MEAN{\nu_{\mbox{eff}}}}{(\mu_eE)^2}}\right).
\end{equation}
(The last expression if valid only if $\mu_eE\neq 0$.)
...
Substitution of equation \eqref{eq:Gamma_u-sst} and division by $N$ result in
\begin{equation}
	\frac{\alpha_{\mbox{eff}}}{N}\left(\frac{E}{N}(\mu_u E)n_e\MEAN{u} - \frac{\alpha_{\mbox{eff}}}{N}(D_uN)\MEAN{u}\right)
	- \Gamma
\end{equation}

BOLSIG+ manual \cite[p. 18,19]{BolsigManual2016}.
