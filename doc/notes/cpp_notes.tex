...
electrons, with the volumetric (net) power gained by the electrons
...
yields and expression for the electron {\em energy} flux density,
\begin{equation}
...
coefficients are not used anywhere, wheras in Hagelaar's text also the corresponding
transport equation for the (mean) energy is stated and discussed.
...
although I (JvD) have not been able to spot these coefficients in that paper.
\end{framed}
The expression for LoKI-B's $\mu_eN$ is given in \cite[eq. 48b]{Manual_2_2_0}.
...
TODO: energy balance for the spatial growth model.
