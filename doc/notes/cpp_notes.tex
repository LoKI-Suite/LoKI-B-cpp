...
\begin{align}
	...
	&\sqrt{u}f^1_u\MEAN{K_{eff}}
	+\frac{\sqrt{u}}{N} \PDEV{f^1_u}{t}
	- \frac{E}{N}\gamma u\PDEV{f^0_u}{u}
	= -\sigma_m(u)\gamma uf^1_u.
	\label{eq:ebe-2term-f-u-ddt1}
\end{align}
The second equation can be written as
\begin{equation}
	f^1_u(u)
	+ \frac{1}{N(\MEAN{K_{eff}}+\sigma_m(u)\gamma\sqrt{u})}\PDEV{f^1_u}{t}
	= \frac{E}{N}\frac{\gamma\sqrt{u}}{\MEAN{K_{eff}}+\sigma_m(u)\gamma\sqrt{u}}\DERIV{f^0}{u}.
\end{equation}
