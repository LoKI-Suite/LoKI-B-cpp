...
over cell $k$ and dividing by the energy interval $\Delta u$,
\begin{equation}
...
\begin{itemize}
	...
	the diagonal of the discretization natrix is positive, the equation is
...
with respect to the manual for reasons of readability.
...
\begin{itemize}
	...
	\item Discuss properties of the SDCS. I do not understand Opal's expression
		\eqref{eq:sigma_ion(sigma_ion_sdcs)}:
		I had expected a factor 2 on the RHS of that equation if the integral
		domain is halved in view of symmery of $u'$ with respect to $(u-V_{ion,i})/2$.
		Is that factor is absorbed in the definition of
		$\sigma_{ion,i}^{sec}(u,u')$? Explain.
...
\begin{framed}
Note that the expression for the source in the BOLSIG+ paper \cite[29]{Hagelaar2005}
