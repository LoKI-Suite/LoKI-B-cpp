...
$\tilde{C}_u(u)$,
\begin{equation}
	\tilde{C}^0(u) = 2\pi\gamma^3\frac{C_u^0(u)\sqrt{u}}{Nn_e},
	\label{eq:Ctilde0}
\end{equation}
...
\end{equation}
\begin{framed}
A small intermezzo: let's verify the integral of this equation over energy:
\begin{align*}
...
TODO: verify that also the discrete form is conistent.
\end{framed}
